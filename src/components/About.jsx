  ...
  return (
    <div id="aboutSection" className="about-section">
      ...
      <div className="about-body">
        <div className="experience" data-aos="fade-up">
          ...
          <div className="timeline">
            ...
            >
              ...
              <p>
                Trained on Machine Learning algorithms and developed projects on
                it.
              </p>
            </div>
          </div>
        ...
        {/* Main -> Python Full Stack one block, Udemy linkedin another block and miscelenious another */}
                ...
                <div className="card-inner">
                  <img
                    ...
                    src={`${process.env.PUBLIC_URL}/assets/${
                      theme === "dark" ? "udemy.png" : "udemy_light.png"
                    }`}
                    alt="udemy-logo"
                  />
                  <div className="card-desc">
